...
// Returns true if work was successfully stolen and queued.
func (d *ConcurrentDownloader) StealWork(queue *TaskQueue) bool {
	...
	// Only consider workers with enough remaining work to split
	...
	if bestID == -1 {
		return false // No suitable candidates for work stealing
	}
